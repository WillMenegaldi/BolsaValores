...
namespace BolsaDeValores.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,Admin")] Clients clients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,Admin")] Clients clients)
        {
            if (id != clients.Id)
            {
                return NotFound();
        ...
        {
            return View(await _context.Actions.Where(m => m.IdOwner == Program.currentId).ToListAsync());
        }
